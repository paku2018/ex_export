...
{{--                            <p class="mb-0">You should register to the Application to get the orders list.</p>--}}
{{--                            <a href="{{$site_url}}" class="btn btn-custom ml-3">Register</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{$site_url}}" type="button" class="btn btn-success">@lang('get_orders_list')</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="dt_orders" class="display table table-striped table-hover" >
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-capitalize">{{__($item->type)}}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{route('seller.order.edit',$item->id)}}" type="button" class="btn btn-link btn-primary btn-lg">
...
@section('page-js')
    ...
    <script>
        let syncApi = '{{session()->get('sync_api')}}';
        if(syncApi==1)
            swal({
                title: '@lang('success')',
                text: "@lang('got_all_api').",
                type: 'success',
                icon: 'info',
                buttons:{
                    confirm: {
        ...
        function delOrder(id) {
            swal({
                ...
                if (confirmed) {
                    ...
                    let path = '{{route('seller.order.delete')}}'
